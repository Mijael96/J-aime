...
<h1>Cocina</h1>  <!-- lo cambiamos -->
    <section class="catalogo">
    <div class="container productos">
        <div class="row">

        <div class="col-md-3 col-sm-12">
                        <a href="/receta"><img  src="/Imagenes/cocina2.jpg"></a>
                        <h3><a href="productos/receta.html">Receta</a></h3>
		...
		<div class="row"> 
                    ...
                    <div class="col-md-3 col-sm-12">
                        <a href="/condimentos"><img src="/Imagenes/cocina6.jpg"></a>
